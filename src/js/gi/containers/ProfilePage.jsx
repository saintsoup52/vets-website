...
import BenefitCalculator from '../components/profile/calculator/BenefitCalculator';
import RetentionRates from '../components/profile/outcomes/RetentionRates';
import GraduationRates from '../components/profile/outcomes/GraduationRates';
import SalaryRates from '../components/profile/outcomes/SalaryRates';
import RepaymentRates from '../components/profile/outcomes/RepaymentRates';
          ...
          <div className="section one">
                  ...
                  <li className="accordion-navigation">
                    ...
                    <div id="panel-benefits-calculator" className="content active">
                      <BenefitCalculator
                          ...
                          toggleModalDisplay={this.toggleModalDisplay}
                          militaryStatus={this.props.queryParams.military_status}
                          spouseActiveDuty={this.props.queryParams.spouse_active_duty}
                          giBillChapter={this.props.queryParams.gi_bill_chapter}
                          eligForPostGiBill={this.props.queryParams.elig_for_post_gi_bill}
                          cumulativeService={this.props.queryParams.cumulative_service}
                          consecutiveService={this.props.queryParams.consecutive_service}
                          enlistmentService={this.props.queryParams.enlistment_service}
                          online={this.props.queryParams.online_classes}/>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="row">
              <div className="small-12 columns accordion-vert-spacing">
                <ul className="accordion" data-accordion>
                  <li className="accordion-navigation">
                    <a href="#panel-caution-flags" aria-expanded="true">Caution Flags ({this.props.institution.complaintsMainCampusRollUp} Student Complaints)</a>
