class Calculator {
  ...
  recalculate() {
    this.getValues();
    this.getDerivedValues();
    // this.component.updateVisibility();
    this.writeOutputs();
  }
...
Calculator.prototype.updateInState = function updateInState() {
  if (!this.inState) {
    this.tuitionFeesInput = this.formatCurrency(this.institution.tuitionOutOfState);
  } else {
    this.tuitionFeesInput = this.formatCurrency(this.institution.tuitionInState);
  }
};
...
Calculator.prototype.populateInputs = function populateInputs() {
  ...
  this.inStateTuitionFees = this.tuitionFeesInput = t;
  this.booksInput = this.formatCurrency(this.institution.books);
  if (this.institution.calendar) {
    this.calendar = this.institution.calendar.toLowerCase();
  } else {
    this.calendar = 'semesters';
  }
};
...
// Formats postivie and negative currency values in USD
